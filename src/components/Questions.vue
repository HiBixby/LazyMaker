    ...
    <div class="flex flex-col flex-1 justify-center">
      ...
      <div class="options">
        <button
          ...
          class="border-2 rounded-lg my-5 p-5 block w-full min-h-[8rem] break-words"
        >
          {{ option }}
        </button>
      </div>
